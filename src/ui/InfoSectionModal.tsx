...
export const InfoSectionModal: React.FC<InfoSectionModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/75 backdrop-blur-sm flex items-center justify-center p-2 sm:p-4 overflow-y-auto">
      <div className="bg-[#0a0f18] border border-[#16202f] rounded-xl w-full max-w-4xl overflow-hidden shadow-2xl flex flex-col my-auto max-h-[90vh]">
        {/* Header */}
        <div className="flex items-center justify-between px-5 py-3.5 border-b border-[#16202f] bg-[#0e1624] shrink-0">
          ...
          <button
            onClick={onClose}
            className="p-1.5 text-[#8ea3bd] hover:text-white rounded-lg bg-[#05070c] border border-[#16202f] transition cursor-pointer"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
        ...
        {/* Nav Tabs */}
        <div className="flex items-center gap-2 px-5 py-2.5 bg-[#05070c] border-b border-[#16202f] overflow-x-auto text-xs font-semibold shrink-0">
          <button
        ...
        <div className="p-6 overflow-y-auto space-y-6 text-sm">
            ...
            <div className="space-y-4">
              ...
              <div className="grid sm:grid-cols-2 gap-4 pt-2">
                ...
                <div className="p-4 bg-[#0e1624] border border-[#16202f] rounded-xl space-y-2">
                  ...
                  <div className="text-xs text-[#8ea3bd]">Filtro estructural y penalizaciones por flexión y divergencia aeroelástica.</div>
                </div>
              </div>
            </div>
          )}
            ...
            <div className="space-y-4">
              ...
              <div className="grid sm:grid-cols-2 gap-4 pt-2">
                <div className="p-4 bg-[#0e1624] border border-[#16202f] rounded-xl">
                  ...
                  <p className="text-xs text-[#8ea3bd] mt-1">Cálculo de CL, CD, Cm, L/D y factor de Oswald ajustado por Mach y Reynolds.</p>
                </div>
                ...
                <div className="p-4 bg-[#0e1624] border border-[#16202f] rounded-xl">
                  ...
                  <p className="text-xs text-[#8ea3bd] mt-1">Algoritmo con 80 generaciones para maximizar eficiencia bajo presupuesto y peso.</p>
                </div>

                <div className="p-4 bg-[#0e1624] border border-[#16202f] rounded-xl">
                  <Layers className="w-5 h-5 text-blue-400 mb-2" />
                  <h3 className="font-bold text-white text-sm">Visualizador 3D WebGL</h3>
                  <p className="text-xs text-[#8ea3bd] mt-1">Inspección con mapa de presiones, malla 3D y vista de sección de perfil.</p>
                </div>
          ...
          {activeTab === 'planes' && (
            <div className="space-y-4">
              ...
              <div className="grid sm:grid-cols-3 gap-4 pt-2">
                <div className="p-4 bg-[#0e1624] border border-[#16202f] rounded-xl flex flex-col justify-between">
                  <div>
                    <h3 className="font-bold text-white">Gratuito</h3>
                    <div className="text-xl font-black text-cyan-400 font-mono mt-1">0 € / mes</div>
                    <p className="text-xs text-[#8ea3bd] mt-2">3 créditos/mes, modelo empírico básico.</p>
                  </div>
                  <button
                    onClick={() => {
                      onClose();
                    ...
                    className="mt-4 py-1.5 w-full rounded bg-[#0e1624] text-cyan-300 font-bold text-xs hover:bg-cyan-500/20 transition cursor-pointer"
                  >
                    Elegir Plan
                  </button>
                </div>

                <div className="p-4 bg-[#0e1624] border-2 border-cyan-400 rounded-xl flex flex-col justify-between">
                  <div>
                  ...
                  <button
                    ...
                    className="mt-4 py-1.5 w-full rounded bg-cyan-500 text-[#05070c] font-bold text-xs hover:brightness-110 transition cursor-pointer"
                  >
                    Elegir Plan
                  </button>
                </div>
                ...
                <div className="p-4 bg-[#0e1624] border border-[#16202f] rounded-xl flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-xs text-[#8ea3bd] mt-2">I+D ilimitado, SLA e integración con clústeres propios.</p>
                  </div>
                  <button
                    onClick={() => {
                      onClose();
                    ...
                    className="mt-4 py-1.5 w-full rounded bg-[#0e1624] text-purple-300 font-bold text-xs hover:bg-purple-500/20 transition cursor-pointer"
                  >
                    Elegir Plan
                  </button>
                </div>
          ...
          {activeTab === 'normativa' && (
            <div className="space-y-4">
              ...
              <div className="p-4 bg-[#0e1624] border border-[#16202f] rounded-xl space-y-3 text-xs text-[#8ea3bd] leading-relaxed">
