...
export const InfoSectionModal: React.FC<InfoSectionModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/75 backdrop-blur-sm flex items-center justify-center p-2 sm:p-4 overflow-y-auto">
      <div className="bg-[#0a111c] border border-[#1e2d42] rounded-xl w-full max-w-4xl overflow-hidden shadow-2xl flex flex-col my-auto max-h-[90vh]">
        {/* Header */}
        <div className="flex items-center justify-between px-5 py-3.5 border-b border-[#1e2d42] bg-[#0d1520] shrink-0">
          ...
          <button
            onClick={onClose}
            className="p-1.5 text-[#9aaec9] hover:text-white rounded-lg bg-[#070b12] border border-[#1e2d42] transition cursor-pointer"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
        ...
        {/* Nav Tabs */}
        <div className="flex items-center gap-2 px-5 py-2.5 bg-[#070b12] border-b border-[#1e2d42] overflow-x-auto text-xs font-semibold shrink-0">
          <button
        ...
        <div className="p-6 overflow-y-auto space-y-6 text-sm">
          {activeTab === 'quienes-somos' && (
            <div className="space-y-4">
              ...
              <p className="text-[#9aaec9] leading-relaxed">
              ...
              <div className="grid sm:grid-cols-2 gap-4 pt-2">
                <div className="p-4 bg-[#0d1520] border border-[#1e2d42] rounded-xl space-y-2">
                  <Cpu className="w-5 h-5 text-cyan-400" />
                  <div className="font-bold text-white text-xs">Modelos Surrogate NeuralFoil</div>
                  <div className="text-xs text-[#9aaec9]">Aceleración mediante redes neuronales convolucionales 2D/3D.</div>
                </div>
                <div className="p-4 bg-[#0d1520] border border-[#1e2d42] rounded-xl space-y-2">
                  <ShieldCheck className="w-5 h-5 text-emerald-400" />
                  <div className="font-bold text-white text-xs">Conformidad Física</div>
                  <div className="text-xs text-[#9aaec9]">Filtro estructural y penalizaciones por flexión y divergencia aeroelástica.</div>
                </div>
              </div>
            </div>
          )}
          ...
          {activeTab === 'servicios' && (
            <div className="space-y-4">
              ...
              <div className="grid sm:grid-cols-2 gap-4 pt-2">
                <div className="p-4 bg-[#0d1520] border border-[#1e2d42] rounded-xl">
                  ...
                  <p className="text-xs text-[#9aaec9] mt-1">Cálculo de CL, CD, Cm, L/D y factor de Oswald ajustado por Mach y Reynolds.</p>
                </div>
                ...
                <div className="p-4 bg-[#0d1520] border border-[#1e2d42] rounded-xl">
                  ...
                  <p className="text-xs text-[#9aaec9] mt-1">Algoritmo con 80 generaciones para maximizar eficiencia bajo presupuesto y peso.</p>
                </div>

                <div className="p-4 bg-[#0d1520] border border-[#1e2d42] rounded-xl">
                  <Layers className="w-5 h-5 text-blue-400 mb-2" />
                  <h3 className="font-bold text-white text-sm">Visualizador 3D WebGL</h3>
                  <p className="text-xs text-[#9aaec9] mt-1">Inspección con mapa de presiones, malla 3D y vista de sección de perfil.</p>
                </div>
                ...
                <div className="p-4 bg-[#0d1520] border border-[#1e2d42] rounded-xl">
                  ...
                  <p className="text-xs text-[#9aaec9] mt-1">Exportación en PDF con tablas de geometría y advertencias de cumplimiento.</p>
                </div>
              </div>
            </div>
          )}
          ...
          {activeTab === 'planes' && (
            <div className="space-y-4">
              ...
              <div className="grid sm:grid-cols-3 gap-4 pt-2">
                <div className="p-4 bg-[#0d1520] border border-[#1e2d42] rounded-xl flex flex-col justify-between">
                  <div>
                    <h3 className="font-bold text-white">Gratuito</h3>
                    <div className="text-xl font-black text-cyan-400 font-mono mt-1">0 € / mes</div>
                    <p className="text-xs text-[#9aaec9] mt-2">3 créditos/mes, modelo empírico básico.</p>
                  </div>
                  <button
                    onClick={() => {
                      onClose();
                    ...
                    className="mt-4 py-1.5 w-full rounded bg-[#131f2e] text-cyan-300 font-bold text-xs hover:bg-cyan-500/20 transition cursor-pointer"
                  >
                    Elegir Plan
                  </button>
                </div>

                <div className="p-4 bg-[#0d1520] border-2 border-cyan-400 rounded-xl flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-xs text-[#9aaec9] mt-2">100 créditos/mes, motor IA NeuralFoil, optimizador completo.</p>
                  </div>
                  <button
                    onClick={() => {
                      onClose();
                    ...
                    className="mt-4 py-1.5 w-full rounded bg-cyan-500 text-slate-950 font-bold text-xs hover:brightness-110 transition cursor-pointer"
                  >
                    Elegir Plan
                  </button>
                </div>
                ...
                <div className="p-4 bg-[#0d1520] border border-[#1e2d42] rounded-xl flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-xs text-[#9aaec9] mt-2">I+D ilimitado, SLA e integración con clústeres propios.</p>
                  </div>
                  <button
                    onClick={() => {
                      onClose();
                    ...
                    className="mt-4 py-1.5 w-full rounded bg-[#131f2e] text-purple-300 font-bold text-xs hover:bg-purple-500/20 transition cursor-pointer"
                  >
                    Elegir Plan
                  </button>
                </div>
          ...
          {activeTab === 'normativa' && (
            <div className="space-y-4">
              ...
              <div className="p-4 bg-[#0d1520] border border-[#1e2d42] rounded-xl space-y-3 text-xs text-[#9aaec9] leading-relaxed">
