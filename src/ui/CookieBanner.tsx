  ...
  return (
    <>
      ...
      {showBanner && !showDetailsModal && (
        <div className="fixed bottom-0 left-0 right-0 z-50 p-4 bg-[#0a111c]/95 border-t border-[#1e2d42] backdrop-blur-md shadow-2xl">
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-start gap-3">
              ...
              <div className="text-xs text-[#9aaec9] leading-relaxed">
                <span className="font-bold text-[#e8edf4] block text-sm mb-0.5">
            ...
            <div className="flex items-center gap-2 shrink-0">
              <button
                ...
                className="px-3.5 py-2 rounded-lg bg-[#0d1520] text-xs font-semibold text-[#9aaec9] border border-[#1e2d42] hover:text-white hover:border-[#2a4060] transition cursor-pointer"
              >
                Configurar
              </button>
              <button
                onClick={handleAcceptAll}
                className="px-4 py-2 rounded-lg bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold text-xs transition shadow-md shadow-cyan-500/20 cursor-pointer"
              >
                Aceptar Todas
              </button>
            </div>
      ...
      {showDetailsModal && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-[#0a111c] border border-[#1e2d42] rounded-xl w-full max-w-xl overflow-hidden shadow-2xl flex flex-col">
            <div className="flex items-center justify-between px-5 py-4 border-b border-[#1e2d42] bg-[#0d1520]">
              ...
              <button onClick={() => setShowDetailsModal(false)} className="text-[#9aaec9] hover:text-white transition cursor-pointer">
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="p-6 flex flex-col gap-4 overflow-y-auto max-h-[70vh] text-xs">
              ...
              {/* Necessary */}
              <div className="bg-[#0d1520] p-4 rounded-lg border border-[#1e2d42] flex items-start justify-between gap-3">
                <div>
                  <div className="flex items-center gap-2 font-bold text-[#e8edf4]">
                    <Lock className="w-3.5 h-3.5 text-cyan-400" />
                    <span>Cookies Técnicas Necesarias</span>
                  </div>
                  <p className="text-[#5a7390] mt-1 text-[11px]">
              ...
              <div className="bg-[#0d1520] p-4 rounded-lg border border-[#1e2d42] flex items-start justify-between gap-3">
                ...
                <input
                  ...
                  className="w-4 h-4 rounded border-[#1e2d42] bg-[#070b12] text-cyan-500 focus:ring-cyan-500/20 cursor-pointer mt-1"
                />
              </div>
            ...
            <div className="px-6 py-4 bg-[#0d1520] border-t border-[#1e2d42] flex items-center justify-end gap-2">
              <button
                onClick={handleSavePreferences}
                className="px-4 py-2 rounded-lg bg-[#131f2e] text-xs font-bold text-cyan-300 border border-[#1e2d42] hover:bg-cyan-500/20 transition cursor-pointer"
              >
                Guardar Configuración
              </button>
              <button
                onClick={handleAcceptAll}
                className="px-4 py-2 rounded-lg bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold text-xs transition shadow-md cursor-pointer"
              >
                Aceptar Todas
              </button>
            </div>
